  ...
  <div class="min-h-screen">
    ...
    <div class="flex items-center justify-between px-4 sm:px-8 py-4 sm:py-6">
      <div class="flex items-center gap-3 sm:gap-4">
        <router-link
            to="/"
            class="p-2 sm:p-3 bg-white/60 backdrop-blur-sm border border-white/40 rounded-full
    ...
    <div class="px-4 sm:px-8 py-4 sm:py-6 max-w-5xl mx-auto">
      <div class="bg-white/70 backdrop-blur-md border border-white/40
        ...
        <div class="flex items-center gap-3 mb-6">
          <div class="w-10 h-10 sm:w-12 sm:h-12 bg-white/50 border border-white/30 rounded-full
        ...
        <div class="mb-6">
          ...
          <input
              ...
              class="w-full h-2 bg-white/40 rounded-full appearance-none cursor-pointer
        ...
        <div class="flex items-center justify-between p-3 sm:p-4
                    bg-white/40 border border-white/30 rounded-xl sm:rounded-2xl">
