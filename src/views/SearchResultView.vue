    ...
    <div class="w-full max-w-4xl">
      ...
      <div v-else class="glass-strong
        ...
        <div class="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-white/20">
          <router-link
              to="/library"
              class="block w-full py-3 sm:py-4 glass-subtle
                   rounded-full hover:bg-white/25 transition-all
